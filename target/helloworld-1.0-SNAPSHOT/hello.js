...
function enableButtons () {
	...
	btn = document.getElementById("input_greet_by_old");
	btn.onclick=function(){greetByOld();};
	
	// Update the button label now that the button is active
	btn.value="Click me to check your age";
...
function greetByOld(){
	var old = document.getElementById("old_field").value;
	var request = gapi.client.helloworldendpoints.greetByOld
	({'old': old});
	request.execute(sayHelloCallback);
}
